 ...
 * 
 * Resumen.
 * Objeto : RepresasDaoImpl
 * Descripción : Clase de implementación de métodos de persistencia para el mantenimiento de Represas
...
public class RepresasDaoImpl implements IRepresasDao {
	...
	public RepresasBean registrarRepresas(RepresasBean represasBean) throws Exception {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), 
					CoreUtils.concatenar(Constants.PACKAGE_REPRESAS,ConstantsCommon.P_SEPARADOR,Constants.SP_INSERT_REPRESAS), paramsInput, paramsOutput);
	 ...
	 * @param rioBean objeto del tipo RepresasBean que contiene el registro 
	 * @throws Exception Excepción que puede ser lanzada
	 **/
	@Override
	public void actualizarRepresas(RepresasBean represasBean) throws Exception {		
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), Constants.PACKAGE_REPRESAS+Constants.P_SEPARADOR+Constants.SP_UPDATE_REPRESAS, paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
	...
	public void actualizarFactorRepresas(RepresasBean represasBean) throws Exception {		
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), Constants.PACKAGE_REPRESAS+Constants.P_SEPARADOR+Constants.SP_UPDATE_FACTOR_REPRESAS, paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
			inputs.put(Constants.PAR_NCODIGO_REPRESAS, Integer.parseInt(represasBean.getCodigo()));
	...
	public void actualizarFormulasRepresas(CalculoRepresasBean calculoRepresasBean) throws Exception {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), Constants.PACKAGE_REPRESAS+Constants.P_SEPARADOR+Constants.SP_UPDATE_FORMULAS_REPRESAS, paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
	...
	public void inactivarRepresas(RepresasBean represasBean) throws Exception {		
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), CoreUtils.concatenar(Constants.PACKAGE_REPRESAS,ConstantsCommon.P_SEPARADOR,Constants.SP_INACTIVA_REPRESAS), paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
	...
	public Integer obtenerCatidadRepresasActivaPorFecha(String strFecha, Integer intCodRepresa) throws Exception {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), CoreUtils.concatenar(Constants.PACKAGE_REPRESAS,ConstantsCommon.P_SEPARADOR,Constants.SP_GET_CANTIDAD_REPRESAS_FECHA), paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
	...
	public BigDecimal obtenerAforoRioRimac(String strPeriodo, String strDia) throws Exception {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), CoreUtils.concatenar(Constants.PACKAGE_REPRESAS,ConstantsCommon.P_SEPARADOR,Constants.SP_GET_AFORO_RIO_RIMAC), paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
