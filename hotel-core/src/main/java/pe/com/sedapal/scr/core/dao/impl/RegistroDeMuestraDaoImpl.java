...
//		params.addValue(Constants.PAR_VESTADO_CLIMA, climaBean.getEstado());
	...
	public void grabarMuestra(Formulario153 formulario153)  {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), 
					CoreUtils.concatenar(Constants.PKG_REG_MUESTRAS,ConstantsCommon.P_SEPARADOR,Constants.SP_INSERT_MUESTRA), lstParamsInput, lstParamsOutput);
	...
	public void actualizarFormulario(Formulario153 formulario153) {
		...
		//	paramsInput.add(new SqlParameter(ConstantsLaboratorio.A_PAR_NOMBRE_PROGRAMA, OracleTypes.VARCHAR));
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), ConstantsLaboratorio.PKG_REG_MUESTRAS+ConstantsLaboratorio.P_SEPARADOR+ConstantsLaboratorio.SP_UPDATE_FORMULARIO, paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
...
//			paramsInput.add(new SqlParameter(ConstantsLaboratorio.P_U_MODIFICACION, OracleTypes.VARCHAR));
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), CoreUtils.concatenar(ConstantsLaboratorio.PKG_REG_MUESTRAS,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.PRC_ELIMINA_FORMULARIO), paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
