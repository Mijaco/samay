...
public class FormulaMuestraDaoImpl implements IFormulaMuestraDao {
	...
	public int grabarFormulaMuestra(FormulaMuestraBean formulaMuestraBean) throws Exception {
		...
		int intRetorno=-1;
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), 
					CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_FORMULA_MUESTRA,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_INSERT_FORMULA_MUESTRA), lstParamsInput, lstParamsOutput);
	...
	public void actualizarFormulaMuestra(FormulaMuestraBean formulaMuestraBean) throws Exception {
		...
		Map<String, Object> inputs = null;
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), 
					CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_FORMULA_MUESTRA,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_UPDATE_FORMULA_MUESTRA), lstParamsInput, lstParamsOutput);
			inputs = new HashMap<String, Object>();			
			...
			inputs.put(Constants.PAR_CUSUARIO_CREACION, formulaMuestraBean.getIntCodGrupo());	
			inputs.put(Constants.PAR_CUSUARIO_MODI, formulaMuestraBean.getIntCodGrupo());	
			inputs.put(Constants.PAR_CPROGRAMA, formulaMuestraBean.getIntCodGrupo());	
	...
	public void inactivarFormulaMuestra(FormulaMuestraBean formulaMuestraBean) throws Exception {
		...
		Map<String, Object> inputs = null;
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_FORMULA_MUESTRA,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_INACTIVA_FORMULA_MUESTRA), paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
