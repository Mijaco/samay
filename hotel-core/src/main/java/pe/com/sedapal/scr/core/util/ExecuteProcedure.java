 ...
 * 
 * Resumen.
 * Objeto : ExecuteProcedure
 * Descripción : Clase de Utilitaria para la ejecución de Procedimientos Almacenados
...
public class ExecuteProcedure extends StoredProcedure {
	 ...
	 * @param paramOutput Son los parámetros de salida del procedimiento almacenado
