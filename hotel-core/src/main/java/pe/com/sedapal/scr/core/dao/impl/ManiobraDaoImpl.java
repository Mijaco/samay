 ...
 * 
 * Resumen.
 * Objeto : ManiobraDaoImpl
 * Descripción : Clase de implementación de métodos de acceso a datos para las maniobras
...
public class ManiobraDaoImpl implements IManiobraDao {
	...
	public void registrarManiobra(ManiobraBean maniobraBean) throws Exception {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), 
					CoreUtils.concatenar(Constants.PACKAGE_MANIOBRAS,ConstantsCommon.P_SEPARADOR,Constants.SP_INSERT_MANIOBRAS), paramsInput, paramsOutput);
	...
	public void actualizarManiobra(ManiobraBean maniobraBean) throws Exception {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), Constants.PACKAGE_MANIOBRAS+Constants.P_SEPARADOR+Constants.SP_UPDATE_MANIOBRAS, paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
	...
	public void inactivarManiobra(ManiobraBean maniobraBean) throws Exception {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), CoreUtils.concatenar(Constants.PACKAGE_MANIOBRAS,ConstantsCommon.P_SEPARADOR,Constants.SP_INACTIVA_MANIOBRAS), paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
