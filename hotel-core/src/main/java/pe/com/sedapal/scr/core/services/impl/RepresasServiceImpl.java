 ...
 * 
 * Resumen.
 * Objeto : RepresasServiceImpl
 * Descripción : Clase de implementación de la capa de negocio para la gestión de registros de represas
...
public class RepresasServiceImpl implements IRepresasService {
	...
	public List<FilaReporteRepresaBean> generarReporteResumenRepresa(String periodo) throws Exception {
		...
		for(FilaReporteRepresaBean dato : datosReporte){
			...
			infoAlmacenamiento.setStrRepresasExcluidas(represasExcluidasColUno);
			...
			infoVolumenTotal.setStrRepresasExcluidas(represasExcluidasColUno);
			...
			infoManiobras.setStrRepresasExcluidas(represasExcluidasColUno);
			...
			infoAgregados.setStrRepresasExcluidas(represasExcluidasColUno);
	 ...
	 * @param periodo Es el periodo para el que se requiere generar el reporte
	 * @param mapCiasConData Es un mapa que contiene los días para los cuales hay data en base de datos
