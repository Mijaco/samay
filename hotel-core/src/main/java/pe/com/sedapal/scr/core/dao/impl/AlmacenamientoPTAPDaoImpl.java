...
private static final Logger LOG = LoggerFactory.getLogger(Constants.PACKAGE);
	...
	public int grabarMuestraForm21(AlmacenamientoPTAPFirstBean almacenamientoPTAPFirstBean) throws Exception {
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), 
				CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_ALMACENA_PTAP,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_INSERT_MUESTRFORM21), lstParamsInput, lstParamsOutput);
	...
	public int grabarReporteAlmacenamientoPTAP(ReporteAlmacenamientoPTAPBean reporteAlmacenamientoPTAPBean) throws Exception {
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), 
				CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_ANALISIS_BACTERIOLOGICO,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_INSERT_MUESTRFOR299), lstParamsInput, lstParamsOutput);
		inputs = new HashMap<String, Object>();				
						...
						new SqlOutParameter(Constants.PAR_OUTQUANTITY, Types.INTEGER), new SqlOutParameter(
								ConstantsCommon.PAR_OUT_CURSOR, OracleTypes.CURSOR, new RowMapper<ArrayList>() {
									...
									public ArrayList mapRow(ResultSet rs, int rowNum) throws SQLException {
										...
										record.add(rs.getString(12)); // ""
										record.add(rs.getString(13)); // ""
										record.add(rs.getString(14)); // ""
										record.add(rs.getString(15)); // ""
										record.add(rs.getString(16)); // ""
										record.add(rs.getString(17)); // ""
	...
	public int updateMuestraForm21(AlmacenamientoPTAPFirstBean almacenamientoPTAPFirstBean) throws Exception {
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), 
				CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_ALMACENA_PTAP,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_UPDATE_MUESTRFORM21), lstParamsInput, lstParamsOutput);
		inputs = new HashMap<String, Object>();				
		inputs.put(ConstantsLaboratorio.PAR_NID_CABECERA, almacenamientoPTAPFirstBean.getIntIdCabecera());	
	...
	public int grabarTableSecond(AlmacenamientoPTAPSecondBean almacenamientoPTAPSecondBean) throws Exception {
       ...
       lstParamsInput.add(new SqlParameter(ConstantsLaboratorio.PAR_CESCOLI, OracleTypes.VARCHAR));
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), 
				CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_ALMACENA_PTAP,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_INSERT_MUESTELEF21), lstParamsInput, lstParamsOutput);
		inputs = new HashMap<String, Object>();				
      ...
      inputs.put(ConstantsLaboratorio.PAR_CCOLTOT, almacenamientoPTAPSecondBean.getStrColtot());                
	...
	public void inactivarTableSecond(AlmacenamientoPTAPSecondBean almacenamientoPTAPSecondBean) throws Exception {
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), 
				CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_ALMACENA_PTAP,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_INACTIVA_MUESTELEF21), paramsInput, paramsOutput);
		inputs = new HashMap<String, Object>();
	...
	public int grabarTableThree(AlmacenamientoPTAPThreeBean almacenamientoPTAPThreeBean) throws Exception {
       ...
       lstParamsInput.add(new SqlParameter(ConstantsLaboratorio.PAR_CPSEAE, OracleTypes.VARCHAR));
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), 
				CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_ALMACENA_PTAP,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_INSERT_MUESTEPAF21), lstParamsInput, lstParamsOutput);
		inputs = new HashMap<String, Object>();				
	...
	public void inactivarTableThree(AlmacenamientoPTAPThreeBean almacenamientoPTAPThreeBean) throws Exception {
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), 
				CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_ALMACENA_PTAP,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_INACTIVA_MUESTEPAF21), paramsInput, paramsOutput);
		inputs = new HashMap<String, Object>();
	...
	public void calcularTablaFirst(AlmacenamientoPTAPFirstBean almacenamientoPTAPFirstBean) throws Exception {
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), 
				CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_ALMACENA_PTAP,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_CALCULO_MUESTELEF21), paramsInput, paramsOutput);
		inputs = new HashMap<String, Object>();
