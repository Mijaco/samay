 ...
 * 
 * Resumen.
 * Objeto : CaudalDetalleDaoImpl
 * Descripción : Clase de implementación de la capa de datos para un detalle de caudal
...
public class CaudalDetalleDaoImpl implements ICaudalDetalleDao {
	...
	public Integer registrarCaudalDetalle(CaudalDetalle caudalDetalle) throws Exception {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), spName, lstParamsInput, lstParamsOutput);
