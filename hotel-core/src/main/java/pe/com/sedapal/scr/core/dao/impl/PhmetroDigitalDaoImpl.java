...
public class PhmetroDigitalDaoImpl implements IPhmetroDigitalDao{
	...
	public int grabarPhmetroDigital(PhmetroDigitalBean phmetroDigitalBean) throws Exception {
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), 
				CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_PHMETRO_DIGITAL,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_INSERT_PHMETRO_DIGITAL), lstParamsInput, lstParamsOutput);
		inputs = new HashMap<String, Object>();			
		inputs.put(ConstantsLaboratorio.PAR_NCODIGO_EQUIPO, phmetroDigitalBean.getStrCodEquipo());		
		inputs.put(ConstantsLaboratorio.PAR_CNOMBRE_EQUIPO, phmetroDigitalBean.getStrNomEquipo());
		inputs.put(ConstantsLaboratorio.PAR_CMARCA, phmetroDigitalBean.getStrMarca());	
		inputs.put(ConstantsLaboratorio.PAR_CMODELO, phmetroDigitalBean.getStrModelo());
		inputs.put(ConstantsLaboratorio.PAR_CNRO_SERIE, phmetroDigitalBean.getStrNroSerie());		
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_NOMBRE1, phmetroDigitalBean.getStrCalNombre1());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_NOMBRE2, phmetroDigitalBean.getStrCalNombre2());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_NOMBRE3, phmetroDigitalBean.getStrCalNombre3());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_LOTE1, phmetroDigitalBean.getStrCalLote1());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_LOTE2, phmetroDigitalBean.getStrCalLote2());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_LOTE3, phmetroDigitalBean.getStrCalLote3());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_CODIGO1, phmetroDigitalBean.getStrCalCodigo1());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_CODIGO2, phmetroDigitalBean.getStrCalCodigo2());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_CODIGO3, phmetroDigitalBean.getStrCalCodigo3());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_CADUCIDAD1, phmetroDigitalBean.getStrCalCaducidad1());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_CADUCIDAD2, phmetroDigitalBean.getStrCalCaducidad2());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_CADUCIDAD3, phmetroDigitalBean.getStrCalCaducidad3());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_MARCA1, phmetroDigitalBean.getStrCalMarca1());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_MARCA2, phmetroDigitalBean.getStrCalMarca2());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_MARCA3, phmetroDigitalBean.getStrCalMarca3());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_ESPECIFICACION1, phmetroDigitalBean.getStrCalEspecificacion1());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_ESPECIFICACION2, phmetroDigitalBean.getStrCalEspecificacion2());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_ESPECIFICACION3, phmetroDigitalBean.getStrCalEspecificacion3());	
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_PENDIENTE1, phmetroDigitalBean.getStrCalPendiente1());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_PENDIENTE2, phmetroDigitalBean.getStrCalPendiente2());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_PENDIENTE3, phmetroDigitalBean.getStrCalPendiente3());
		inputs.put(ConstantsLaboratorio.PAR_CCALIF_PENDIENTE4, phmetroDigitalBean.getStrCalPendiente4());		
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_NOMBRE1, phmetroDigitalBean.getStrVerNombre1());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_NOMBRE2, phmetroDigitalBean.getStrVerNombre2());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_NOMBRE3, phmetroDigitalBean.getStrVerNombre3());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_LOTE1, phmetroDigitalBean.getStrVerLote1());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_LOTE2, phmetroDigitalBean.getStrVerLote2());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_LOTE3, phmetroDigitalBean.getStrVerLote3());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_CODIGO1, phmetroDigitalBean.getStrVerCodigo1());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_CODIGO2, phmetroDigitalBean.getStrVerCodigo2());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_CODIGO3, phmetroDigitalBean.getStrVerCodigo3());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_CADUCIDAD1, phmetroDigitalBean.getStrVerCaducidad1());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_CADUCIDAD2, phmetroDigitalBean.getStrVerCaducidad2());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_CADUCIDAD3, phmetroDigitalBean.getStrVerCaducidad3());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_MARCA1, phmetroDigitalBean.getStrVerMarca1());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_MARCA2, phmetroDigitalBean.getStrVerMarca2());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_MARCA3, phmetroDigitalBean.getStrVerMarca3());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_ESPECIFICACION1, phmetroDigitalBean.getStrVerEspecificacion1());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_ESPECIFICACION2, phmetroDigitalBean.getStrVerEspecificacion2());
		inputs.put(ConstantsLaboratorio.PAR_CVERIF_ESPECIFICACION3, phmetroDigitalBean.getStrVerEspecificacion3());
	...
	public void actualizarPhmetroDigital(PhmetroDigitalBean phmetroDigitalBean) throws Exception {
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), 
				CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_PHMETRO_DIGITAL,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_UPDATE_PHMETRO_DIGITAL), lstParamsInput, lstParamsOutput);
		inputs = new HashMap<String, Object>();		
	...
	public void inactivarPhmetroDigital(PhmetroDigitalBean phmetroDigitalBean) throws Exception {
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), 
				CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_PHMETRO_DIGITAL,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_INACTIVA_PHMETRO_DIGITAL), paramsInput, paramsOutput);
		inputs = new HashMap<String, Object>();
	...
	public int grabarPhmetroDigitalDetalle(PhmetroDigitalDetalleBean phmetroDigitalDetalleBean) throws Exception {
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), 
				CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_PHMETRO_DIGITAL,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.SP_INSERT_DETALLE__PTRO_DIGITAL), lstParamsInput, lstParamsOutput);
	...
	public void inactivarPhmetroDigitalDetalle(PhmetroDigitalDetalleBean phmetroDigitalDetalleBean) throws Exception {
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), 
				CoreUtils.concatenar(ConstantsLaboratorio.PACKAGE_PHMETRO_DIGITAL,ConstantsCommon.P_SEPARADOR,ConstantsLaboratorio.PRC_INAC_DETALLE_PTRO_DIGITAL), paramsInput, paramsOutput);
		inputs = new HashMap<String, Object>();
