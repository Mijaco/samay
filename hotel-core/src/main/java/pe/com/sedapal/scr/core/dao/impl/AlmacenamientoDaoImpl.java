...
public class AlmacenamientoDaoImpl implements IAlmacenamientoDao {
	...
	public void actualizarAlmacenamiento(String strFecha, String strFormulaEmbalse, String strFormulaManDescarga, 
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), Constants.PACKAGE_ALMACENAMIENTO+Constants.P_SEPARADOR+Constants.SP_UPDATE_ALMACENAMIENTO, paramsInput, paramsOutput);
