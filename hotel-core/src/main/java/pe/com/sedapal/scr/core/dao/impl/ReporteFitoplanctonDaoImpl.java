...
//										N_CODREP, D_FECREP, D_FECMUE, N_PERMUE, N_PERANA 
	...
	public void insertarReporteFitoplancton(ReporteFitoplanctonDetalle reporteFitoplanctonDetalle) {
		...
		paramsInput.add(new SqlParameter(ConstantsLaboratorio.PAR_CANCLO, OracleTypes.INTEGER));
		paramsInput.add(new SqlParameter(ConstantsLaboratorio.PAR_CANFIC, OracleTypes.INTEGER));
		...
		this.execSp = new ExecuteProcedure(template.getDataSource(), ConstantsLaboratorio.PCK_ALC_REPORFITOPLANCTON
				+ Constants.P_SEPARADOR + ConstantsLaboratorio.PRC_INSERT_REPORTEFITO, paramsInput, paramsOutput);
		inputs = new HashMap<>();
	...
	public boolean eliminarReportePorCorrelativo(Integer idCorrelativo) {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), ConstantsLaboratorio.PCK_ALC_REPORFITOPLANCTON
					+ Constants.P_SEPARADOR + ConstantsLaboratorio.PRC_DELETE_REPORTEFITO, paramsInput, paramsOutput);
			inputs = new HashMap<>();
