...
public class ModuloFormularioBean extends Auditoria implements Serializable, RowMapper<Object> {
	...
	// ---------------------------------------------
	List<AccionFormularioBean> acciones;
	
	public ModuloFormularioBean() {
		super();
	}

	public ModuloFormularioBean(Integer codSistema, Integer codModulo, Integer codFormulario,
	...
	public List<AccionFormularioBean> getAcciones() {
		return acciones;
	}

	public void setAcciones(List<AccionFormularioBean> acciones) {
	...
	public String toString() {
		return "FormularioBean [codSistema=" + codSistema + ", codModulo=" + codModulo + ", codFormulario="
