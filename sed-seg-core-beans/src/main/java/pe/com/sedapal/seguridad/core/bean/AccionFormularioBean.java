...
public class AccionFormularioBean implements Serializable, RowMapper<Object> {
	...
	public AccionFormularioBean() {
	}

	public AccionFormularioBean(Integer codAccionFormulario, Integer codSistema, Integer codModulo, Integer codFormulario,
	...
	public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
		return new AccionFormularioBean(rs.getInt(1), rs.getInt(2), rs.getInt(3), rs.getInt(4), rs.getString(5), rs.getInt(6),
