...
public class ConductimetroDigitalDetalleBean extends BaseBean implements Serializable {
	...
	public int getIntIdConductimetro() {
		return intIdConductimetro;
	}
	public void setIntIdConductimetro(int intIdConductimetro) {
		this.intIdConductimetro = intIdConductimetro;
	}
	...
	public String getStrKCelda() {
		return strKCelda;
	}
	public void setStrKCelda(String strKCelda) {
		this.strKCelda = strKCelda;
	}
	...
	public String getStrOcurrencia() {
		return strOcurrencia;
	}
	public void setStrOcurrencia(String strOcurrencia) {
		this.strOcurrencia = strOcurrencia;
	}
