...
public class ReporteEnsayoCloro extends BaseBean implements Serializable {
	...
	public String toString() {
		return "ReporteEnsayoCloro [fechaMuestreo=" + fechaMuestreo + ", horaMuestreo=" + horaMuestreo
