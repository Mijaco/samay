...
public class ReporteAnalisisHidro extends BaseBean implements Serializable{
	...
	private ArrayList<ReporteAnalisisHidroDetalle> detalles;
	
	/**
	 * @return the detalles
	 */
	public ArrayList<ReporteAnalisisHidroDetalle> getDetalles() {
		return detalles;
	}
	/**
	 * @param detalles the detalles to set
	 */
	public void setDetalles(ArrayList<ReporteAnalisisHidroDetalle> detalles) {
	...
	public String toString() {
		return "ReporteAnalisisHidro [correlativo=" + correlativo + ", fechaReporte=" + fechaReporte
				+ ", fechaMuestreo=" + fechaMuestreo + ", personaMuestra=" + personaMuestra + ", analista=" + analista
				+ ", detalles=" + detalles + "]";
	}
