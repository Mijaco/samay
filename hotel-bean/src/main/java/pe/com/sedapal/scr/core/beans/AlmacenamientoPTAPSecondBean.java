...
public class AlmacenamientoPTAPSecondBean extends BaseBean implements Serializable {
	...
	private String strDescMuestraHide;
	private String strColoni;
	private String strGasclt;
	private String strGasclv;
	private String strGsec24;
	private String strFecmug;
	private String strColtot;
	...
	public String getStrGasclt() {
		return strGasclt;
	}
	public void setStrGasclt(String strGasclt) {
		this.strGasclt = strGasclt;
	}
	public String getStrGasclv() {
		return strGasclv;
	}
	public void setStrGasclv(String strGasclv) {
		this.strGasclv = strGasclv;
	}
	public String getStrGsec24() {
		return strGsec24;
	}
	public void setStrGsec24(String strGsec24) {
		this.strGsec24 = strGsec24;
	}
	public String getStrFecmug() {
		return strFecmug;
	}
	public void setStrFecmug(String strFecmug) {
		this.strFecmug = strFecmug;
	}
	public String getStrColtot() {
		return strColtot;
	}
	public void setStrColtot(String strColtot) {
		this.strColtot = strColtot;
	}
	...
	public String getStrDescMuestraHide() {
		return strDescMuestraHide;
	}
	public void setStrDescMuestraHide(String strDescMuestraHide) {
		this.strDescMuestraHide = strDescMuestraHide;
	}
