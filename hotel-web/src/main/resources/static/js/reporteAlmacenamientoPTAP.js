					...
					validators : {					
	                    ...
	                    callback: {
	                        ...
	                        callback: function(value, validator, $field) {
	                        	var numero = document.getElementById("strReservorioMenacho").value; //ID numero puede ser un input text.
				...
				strReservorioVicentelo: {
					validators : {					
	                    ...
	                    callback: {
	                        message: 'Valor incorrecto',
	                        callback: function(value, validator, $field) {
	                        	var numero = document.getElementById("strReservorioVicentelo").value; //ID numero puede ser un input text.
				...
				strReservorioVicenteloRS: {
					validators : {					
	                    ...
	                    callback: {
	                        message: 'Valor incorrecto',
	                        callback: function(value, validator, $field) {
	                        	var numero = document.getElementById("strReservorioVicenteloRS").value; //ID numero puede ser un input text.
				...
				strCamraRegulacion: {
					validators : {					
	                    ...
	                    callback: {
	                        message: 'Valor incorrecto',
	                        callback: function(value, validator, $field) {
	                        	var numero = document.getElementById("strCamraRegulacion").value; //ID numero puede ser un input text.
