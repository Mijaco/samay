	...
	function addDuplicadoMuestraSecond(idDetalle) {
		...
		$('#myTableMuestraSecond tr').each(function () {
			var idDetalleDupl;
			var descripcion = $(this).find("td").eq(1).html();
			var clres = $(this).find("td").eq(2).html();
			var id = $(this).find("td").eq(10).html();
			...
			if(id == idDetalle){
				...
				idDetalleDupl   = $(this).find("td").eq(10).html();	
	...
	function calcularMuestraFirst() {
		...
		$.confirm({
		    title: 'Confirmaci\u00f3n',
		    content: 'Confirma ejecucion de Calculo de Primera Muestra?',
		    buttons: {
		    	Aceptar: { 
		        	btnClass: 'btn-blue',
		        	action: function () {
	...
	function calcularMuestraSecond() {
		...
		$.confirm({
		    title: 'Confirmaci\u00f3n',
		    content: 'Confirma ejecucion de Calculo de Segunda Muestra?',
		    buttons: {
		    	Aceptar: { 
		        	btnClass: 'btn-blue',
		        	action: function () {
