          	...
          	{"width": "40px",
          		...
          		"render": function ( data, type, row) {//
          			return '<button class="btn btn-info btn-modif-punto" title="Editar" onclick="reporteAnalisisHidroSearch('+row[1]+')"><span class="glyphicon glyphicon-search"></span></button>'+
          			 '<button class="btn btn-danger btn-delete-punto" title="Inactivar" onclick="eliminarReportePorCorrelativo('+row[1]+')"><span class="glyphicon glyphicon-erase"></span></button>';
          		}
          	}
		]
	});
