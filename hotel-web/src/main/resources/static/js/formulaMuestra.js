		...
		fields : {
			strNomFormula: {
				validators : {
					...
					stringLength : {
						max : 60,
						message : "El campo código Lambda ha de ser como m\u00e1ximo 60 caracteres"
					},
					notEmpty: {
                        message: 'Ingrese Nombre de Fórmula'
                    }
				}
            },
            strNomFuncion: {
				validators : {
					...
					stringLength : {
						max : 60,
						message : "El campo código X ha de ser como m\u00e1ximo 60 caracteres"
					},					
					notEmpty: {
                        message: 'Ingrese Nombre de Función'
                    }
				}
            },
            strCodFormulario: {
